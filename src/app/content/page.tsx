    ...
    <div>
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-6 py-10">
        <PageHeader
          ...
          title="Content Hub"
          description="先完成钱包身份验证，再上传知识文件到本地 IPFS，最后将 CID 和元数据登记到链上。"
        />
            ...
            >
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full rounded-xl bg-slate-950 px-5 py-3 text-sm font-medium text-white hover:bg-slate-800 disabled:opacity-50"
                >
                  {isAuthenticating
                    ? "Authenticating..."
                    : uploading
                ...
                <button
                  ...
                  className="w-full rounded-xl border border-slate-300 px-5 py-3 text-sm font-medium text-slate-700 hover:bg-slate-50 disabled:opacity-50"
                >
