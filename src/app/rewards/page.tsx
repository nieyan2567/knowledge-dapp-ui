...
export default function RewardsPage() {
  ...
  const pending = pendingRewards ? Number(formatEther(pendingRewards as bigint)) : 0;
  const budget = epochBudget ? Number(formatEther(epochBudget as bigint)) : 0;
  const spent = epochSpent ? Number(formatEther(epochSpent as bigint)) : 0;
